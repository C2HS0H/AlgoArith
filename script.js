...
function handleDivisionCalculation() {
  try {
    ...
    const result = divider.solve(dividend, divisor);
...
function displayDivisionResults(result) {
  resultsContainer.classList.remove("hidden");
  let html = `
                <h2 class="text-xl sm:text-2xl font-bold text-center text-highlight mb-6">Restoring Division Results</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm font-mono whitespace-nowrap">
                        <thead>
                            <tr><th class="py-3 px-4 text-secondary-text">Cycle</th><th class="py-3 px-4 text-secondary-text">Action</th><th class="py-3 px-4 text-secondary-text">Accumulator (A)</th><th class="py-3 px-4 text-secondary-text">Quotient (Q)</th></tr>
                        </thead>
                        <tbody>
                        ${result.steps
                          .map(
